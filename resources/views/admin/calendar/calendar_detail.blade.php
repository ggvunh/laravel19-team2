                          ...
                          <div class="box-body">
                              <div>
                                 <span style="color: red;font-size:20px">Have </span><span style="color: black;font-size: 25px" >
                                      @if(isset($calendar_detal_result))
                                        {{count($calendar_detal_result)}}
                                      @else
                                          0
                                      @endif
                                    ...
                                    <span style="color: black;font-size: 25px" >
                                       @if(isset($count))
                                        {{number_format($count)}}<span>&nbsp&nbsp&nbsp</span><span style="color: red">VNĐ</span>
                                      @else
                                ...
                                <table class="table table-bordered" id="mytable" border="0">
                                    ...
                                    @if(isset($calendar_detal_result))
                                    @foreach($calendar_detal_result as $bill)
                                    <tr>
