        ...
        <div class="row">
            <div class="col-sm-3 col-left">
                ...
                <form class="form-search-nxp" method="GET" action="search-is-price">
                    ...
                    <input class ="search_price" type="number" min="0" name="keymin" value="{{ isset($_GET['keymin']) ? $_GET['keymin'] : ''}}" placeholder="giá từ..."><br>
                    ...
                    @endif
                        ...
                        <input  class ="search_price" type="number" min="0" name="keymax" value="{{ isset($_GET['keymax']) ? $_GET['keymax'] : ''}}" placeholder="đến..."><br>
